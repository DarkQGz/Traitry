...
export default function ResultPage() {
  ...
  const texts = {
    en: { title: "Result", description: "See your personality analysis results here." },
    mn: { title: "Үр дүн", description: "Энд таны зан төлөвийн шинжилгээний үр дүнг харах боломжтой." },
  };
